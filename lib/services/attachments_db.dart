...
class AttachmentsDB {
  ...
  Future<void> createAttachmentsDB(String name, String url, String type) async {
    return await attachmentReference.doc(name+"__"+url).set({
      'name': name,
      'url': url,
      'type': type,
    });
  ...
  Future<void> createAttachAnnounceDB(String title, String url) async {
    return await attachAnnounceReference.doc(title+"__"+url).set({
      'title': title,
      'url': url,
    });
  }
  ...
  Future<void> createAttachmentStudentsDB(String uid, String url, String announcement) async {
    return await attachStudentReference.doc(uid+"__"+url+"__"+announcement).set({
      'uid': uid,
      'url': url,
